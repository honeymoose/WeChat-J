...
import com.ossez.wechat.common.exception.WxCpErrorMsgEnum;
...
import com.ossez.wechat.wecom.bean.*;
...
public abstract class BaseWxCpTpServiceImpl<H, P> implements WxCpTpService, RequestHttp<H, P> {
  ...
  @Override
  public WeChatAccessToken getSuiteAccessTokenEntity() throws WxErrorException {
    return this.getSuiteAccessTokenEntity(false);
  }

  @Override
  public WeChatAccessToken getSuiteAccessTokenEntity(boolean forceRefresh) throws WxErrorException {
...
//    }
  ...
  public String getSuiteJsApiTicket(String authCorpId) throws WxErrorException {
    if (this.configStorage.isAuthSuiteJsApiTicketExpired(authCorpId)) {
      ...
      String resp = get(configStorage.getApiUrl(WxCpApiPathConsts.Tp.GET_SUITE_JSAPI_TICKET),
  ...
  public String getAuthCorpJsApiTicket(String authCorpId) throws WxErrorException {
    if (this.configStorage.isAuthCorpJsApiTicketExpired(authCorpId)) {
      ...
      String resp = get(configStorage.getApiUrl(WxCpApiPathConsts.Tp.GET_AUTH_CORP_JSAPI_TICKET),
  ...
  @Override
  public WeChatAccessToken getCorpToken(String authCorpId, String permanentCode) throws WxErrorException {
    ...
    return WeChatAccessToken.fromJson(result);
  }

  @Override
  public WeChatAccessToken getCorpToken(String authCorpId, String permanentCode, boolean forceRefresh)
    throws WxErrorException {
    if (this.configStorage.isAccessTokenExpired(authCorpId) || forceRefresh) {
      WeChatAccessToken corpToken = this.getCorpToken(authCorpId, permanentCode);
  ...
  public String getPreAuthUrl(String redirectUri, String state) throws WxErrorException {
    String result = get(configStorage.getApiUrl(WxCpApiPathConsts.Tp.GET_PREAUTH_CODE), null);
  ...
  public WxCpTpAuthInfo getAuthInfo(String authCorpId, String permanentCode) throws WxErrorException {
    ...
    jsonObject.addProperty("auth_corpid", authCorpId);
    jsonObject.addProperty("permanent_code", permanentCode);
    String result = post(configStorage.getApiUrl(WxCpApiPathConsts.Tp.GET_AUTH_INFO), jsonObject.toString());
  ...
  public WxCpTpUserInfo getUserInfo3rd(String code) throws WxErrorException {
    String url = configStorage.getApiUrl(WxCpApiPathConsts.Tp.GET_USERINFO3RD);
  ...
  public WxCpTpUserDetail getUserDetail3rd(String userTicket) throws WxErrorException {
    ...
    String result = post(configStorage.getApiUrl(WxCpApiPathConsts.Tp.GET_USERDETAIL3RD), jsonObject.toString());
  ...
  public WxTpLoginInfo getLoginInfo(String authCode) throws WxErrorException {
    ...
    String responseText = post(configStorage.getApiUrl(WxCpApiPathConsts.Tp.GET_LOGIN_INFO) + "?access_token=" + access_token,
  ...
  public WxTpCustomizedAuthUrl getCustomizedAuthUrl(String state, List<String> templateIdList) throws WxErrorException {
    ...
    String responseText = post(configStorage.getApiUrl(WxCpApiPathConsts.Tp.GET_CUSTOMIZED_AUTH_URL) + "?provider_access_token=" + getWxCpProviderToken(), jsonObject.toString(), true);
  ...
  public String getWxCpProviderToken() throws WxErrorException {
    if (this.configStorage.isProviderTokenExpired()) {
      ...
      WxCpProviderToken wxCpProviderToken =
        WxCpProviderToken.fromJson(this.post(this.configStorage.getApiUrl(WxCpApiPathConsts.Tp.GET_PROVIDER_TOKEN)
          , jsonObject.toString(), true));
  ...
  public WxCpTpAdmin getAdminList(String authCorpId, Integer agentId) throws WxErrorException {
    ...
    String result = post(configStorage.getApiUrl(WxCpApiPathConsts.Tp.GET_ADMIN_LIST), jsonObject.toString());
  ...
  public WxCpTpAppQrcode getAppQrcode(String suiteId, String appId, String state, Integer style, Integer resultType) throws WxErrorException {
    ...
    String result = post(configStorage.getApiUrl(WxCpApiPathConsts.Tp.GET_APP_QRCODE), jsonObject.toString());
  ...
  public WxCpTpCorpId2OpenCorpId corpId2OpenCorpId(String corpId) throws WxErrorException {
    ...
    String result = post(configStorage.getApiUrl(WxCpApiPathConsts.Tp.CORPID_TO_OPENCORPID) +"?provider_access_token=" + getWxCpProviderToken(), jsonObject.toString());
