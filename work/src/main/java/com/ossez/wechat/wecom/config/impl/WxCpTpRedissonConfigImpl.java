...
// lock key
  ...
  @Override
  public WeChatAccessToken getSuiteAccessTokenEntity() {
    ...
    WeChatAccessToken suiteAccessTokenEntity = new WeChatAccessToken();
  ...
  @Override
  public void updateSuiteAccessToken(WeChatAccessToken suiteAccessToken) {
  ...
  @Override
  public WeChatAccessToken getAccessTokenEntity(String authCorpId) {
    ...
    WeChatAccessToken accessTokenEntity = new WeChatAccessToken();
