...
import com.ossez.wechat.common.util.xml.IntegerArrayConverter;
import com.ossez.wechat.common.util.xml.LongArrayConverter;
...
import com.ossez.wechat.wecom.util.xml.XStreamTransformer;
...
public class WxCpXmlMessage implements Serializable {
  ...
  @XStreamAlias("PicUrl")
  @XStreamConverter(value = XStreamCDataConverter.class)
  private final ThreadLocal<String> picUrl = new ThreadLocal<String>();
