...
import com.ossez.wechat.wecom.api.WxCpMsgAuditService;
import com.ossez.wechat.wecom.api.WxCpService;
import com.ossez.wechat.wecom.bean.msgaudit.*;
import com.ossez.wechat.wecom.constant.WxCpApiPathConsts;
import com.ossez.wechat.wecom.util.crypto.WxCpCryptUtil;
 ...
 */
  ...
  public List<String> getPermitUserList(Integer type) throws WxErrorException {
    final String apiUrl = this.cpService.getWxCpConfigStorage().getApiUrl(WxCpApiPathConsts.MsgAudit.GET_PERMIT_USER_LIST);
  ...
  public WxCpGroupChat getGroupChat(@NonNull String roomid) throws WxErrorException {
    final String apiUrl = this.cpService.getWxCpConfigStorage().getApiUrl(WxCpApiPathConsts.MsgAudit.GET_GROUP_CHAT);
    JsonObject jsonObject = new JsonObject();
  ...
  public WxCpAgreeInfo checkSingleAgree(@NonNull WxCpCheckAgreeRequest checkAgreeRequest) throws WxErrorException {
    String apiUrl = this.cpService.getWxCpConfigStorage().getApiUrl(WxCpApiPathConsts.MsgAudit.CHECK_SINGLE_AGREE);
