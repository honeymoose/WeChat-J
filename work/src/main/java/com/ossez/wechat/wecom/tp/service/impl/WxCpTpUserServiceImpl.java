...
import com.ossez.wechat.wecom.bean.WxCpInviteResult;
import com.ossez.wechat.wecom.bean.WxCpUser;
import com.ossez.wechat.wecom.bean.WxCpUserExternalContactInfo;
import com.ossez.wechat.wecom.tp.service.WxCpTpService;
import com.ossez.wechat.wecom.tp.service.WxCpTpUserService;
...
public class WxCpTpUserServiceImpl implements WxCpTpUserService {
  ...
  public void authenticate(String userId) throws WxErrorException {
    this.mainService.get(mainService.getWxCpTpConfigStorage().getApiUrl(WxCpApiPathConsts.User.USER_AUTHENTICATE + userId), null);
  }

  @Override
  public void create(WxCpUser user) throws WxErrorException {
    String url = mainService.getWxCpTpConfigStorage().getApiUrl(WxCpApiPathConsts.User.USER_CREATE);
    this.mainService.post(url, user.toJson());
  }

  @Override
  public void update(WxCpUser user) throws WxErrorException {
    String url = mainService.getWxCpTpConfigStorage().getApiUrl(WxCpApiPathConsts.User.USER_UPDATE);
    this.mainService.post(url, user.toJson());
  }
  ...
  public void delete(String... userIds) throws WxErrorException {
    if (userIds.length == 1) {
      String url = mainService.getWxCpTpConfigStorage().getApiUrl(WxCpApiPathConsts.User.USER_DELETE + userIds[0]);
    ...
    this.mainService.post(mainService.getWxCpTpConfigStorage().getApiUrl(WxCpApiPathConsts.User.USER_BATCH_DELETE),
      jsonObject.toString());
  }

  @Override
  public WxCpUser getById(String userid, String corpId) throws WxErrorException {
    String url = mainService.getWxCpTpConfigStorage().getApiUrl(WxCpApiPathConsts.User.USER_GET + userid);
  ...
  public List<WxCpUser> listByDepartment(Long departId, Boolean fetchChild, Integer status, String corpId) throws WxErrorException {
    ...
    String url = mainService.getWxCpTpConfigStorage().getApiUrl(WxCpApiPathConsts.User.USER_LIST + departId);
  ...
  public List<WxCpUser> listSimpleByDepartment(Long departId, Boolean fetchChild, Integer status)
    ...
    String url = mainService.getWxCpTpConfigStorage().getApiUrl(WxCpApiPathConsts.User.USER_SIMPLE_LIST + departId);
    String responseContent = this.mainService.get(url, params);
    JsonObject tmpJsonElement = GsonParser.parse(responseContent);
    return WxCpGsonBuilder.create()
      .fromJson(
  ...
  public WxCpInviteResult invite(List<String> userIds, List<String> partyIds, List<String> tagIds)
    ...
    String url = mainService.getWxCpTpConfigStorage().getApiUrl(WxCpApiPathConsts.User.BATCH_INVITE);
  ...
  public Map<String, String> userId2Openid(String userId, Integer agentId) throws WxErrorException {
    String url = mainService.getWxCpTpConfigStorage().getApiUrl(WxCpApiPathConsts.User.USER_CONVERT_TO_OPENID);
    JsonObject jsonObject = new JsonObject();
  ...
  public String openid2UserId(String openid) throws WxErrorException {
    ...
    String url = mainService.getWxCpTpConfigStorage().getApiUrl(WxCpApiPathConsts.User.USER_CONVERT_TO_USERID);
    String responseContent = this.mainService.post(url, jsonObject.toString());
    JsonObject tmpJsonElement = GsonParser.parse(responseContent);
  ...
  public String getUserId(String mobile, String corpId) throws WxErrorException {
    ...
    String url = mainService.getWxCpTpConfigStorage().getApiUrl(WxCpApiPathConsts.User.GET_USER_ID)
  ...
  public WxCpUserExternalContactInfo getExternalContact(String userId) throws WxErrorException {
    String url = mainService.getWxCpTpConfigStorage().getApiUrl(WxCpApiPathConsts.User.GET_EXTERNAL_CONTACT + userId);
    String responseContent = this.mainService.get(url, null);
