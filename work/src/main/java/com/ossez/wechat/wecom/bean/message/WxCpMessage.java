...
import com.ossez.wechat.wecom.bean.messagebuilder.*;
import com.ossez.wechat.wecom.bean.taskcard.TaskCardButton;
import com.ossez.wechat.wecom.bean.templatecard.*;
...
public class WxCpMessage implements Serializable {
  ...
  private void handleMsgType(JsonObject messageJson) {
    switch (this.getMsgType()) {
      case WxCpConsts.LinkedCorpMsgType.TEXT: {
        JsonObject text = new JsonObject();
        text.addProperty("content", this.getContent());
        messageJson.add("text", text);
        break;
      }
      case WxCpConsts.LinkedCorpMsgType.MARKDOWN: {
        JsonObject text = new JsonObject();
        text.addProperty("content", this.getContent());
        messageJson.add("markdown", text);
        break;
      }
      case WxCpConsts.LinkedCorpMsgType.TEXTCARD: {
        JsonObject text = new JsonObject();
      ...
      case WxCpConsts.LinkedCorpMsgType.IMAGE: {
        JsonObject image = new JsonObject();
        image.addProperty("media_id", this.getMediaId());
        messageJson.add("image", image);
        break;
      }
      case WxCpConsts.LinkedCorpMsgType.FILE: {
        JsonObject image = new JsonObject();
        image.addProperty("media_id", this.getMediaId());
        messageJson.add("file", image);
        break;
      }
      case WxCpConsts.AppChatMsgType.VOICE: {
        JsonObject voice = new JsonObject();
        voice.addProperty("media_id", this.getMediaId());
        messageJson.add("voice", voice);
        break;
      }
      case WxCpConsts.LinkedCorpMsgType.VIDEO: {
      ...
      case WxCpConsts.LinkedCorpMsgType.NEWS: {
      ...
      case WxCpConsts.LinkedCorpMsgType.MPNEWS: {
        JsonObject newsJsonObject = new JsonObject();
      ...
      case WxCpConsts.LinkedCorpMsgType.MINIPROGRAM_NOTICE: {
