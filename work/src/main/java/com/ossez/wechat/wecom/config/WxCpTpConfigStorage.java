package com.ossez.wechat.wecom.config;
...
public interface WxCpTpConfigStorage {
   ...
   */
  WeChatAccessToken getSuiteAccessTokenEntity();
...
//强制将suite access token过期掉.
   ...
   */
  void updateSuiteAccessToken(WeChatAccessToken suiteAccessToken);
...
//第三方应用的EncodingAESKey，用来检查签名
   ...
   */
  WeChatAccessToken getAccessTokenEntity(String authCorpId);
