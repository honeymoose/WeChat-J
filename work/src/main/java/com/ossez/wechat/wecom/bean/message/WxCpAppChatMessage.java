...
public class WxCpAppChatMessage implements Serializable {
  ...
  private void handleMsgType(JsonObject messageJson) {
    switch (this.getMsgType()) {
      case WxCpConsts.AppChatMsgType.TEXT: {
        JsonObject text = new JsonObject();
        text.addProperty("content", this.getContent());
        messageJson.add("text", text);
        break;
      }
      case WxCpConsts.AppChatMsgType.MARKDOWN: {
        JsonObject text = new JsonObject();
        text.addProperty("content", this.getContent());
        messageJson.add("markdown", text);
        break;
      }
      case WxCpConsts.AppChatMsgType.TEXTCARD: {
        JsonObject text = new JsonObject();
      ...
      case WxCpConsts.AppChatMsgType.IMAGE: {
        JsonObject image = new JsonObject();
        image.addProperty("media_id", this.getMediaId());
        messageJson.add("image", image);
        break;
      }
      case WxCpConsts.AppChatMsgType.FILE: {
        JsonObject image = new JsonObject();
        image.addProperty("media_id", this.getMediaId());
      ...
      case WxCpConsts.AppChatMsgType.VIDEO: {
      ...
      case WxCpConsts.AppChatMsgType.NEWS: {
      ...
      case WxCpConsts.AppChatMsgType.MPNEWS: {
        JsonObject newsJsonObject = new JsonObject();
