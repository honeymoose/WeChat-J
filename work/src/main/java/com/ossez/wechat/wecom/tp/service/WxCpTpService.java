...
public interface WxCpTpService {
   ...
   * @throws WxErrorException the wx error exception
   */
  WeChatAccessToken getSuiteAccessTokenEntity() throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WeChatAccessToken getSuiteAccessTokenEntity(boolean forceRefresh) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WeChatAccessToken getCorpToken(String authCorpId, String permanentCode) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WeChatAccessToken getCorpToken(String authCorpId, String permanentCode, boolean forceRefresh) throws WxErrorException;
