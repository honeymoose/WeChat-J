...
public abstract class BaseWxQidianServiceImpl<H, P> implements WxQidianService, RequestHttp<H, P> {
      ...
      try {
        if (this.getWxMpConfigStorage().isTicketExpired(type)) {
          String responseContent = execute(SimpleGetRequestExecutor.create(this),
              WxQidianApiUrl.Other.GET_TICKET_URL.getUrl(this.getWxMpConfigStorage()) + type.getCode(), null);
  ...
  public String shortUrl(String longUrl) throws WxErrorException {
    ...
    String responseContent = this.post(WxQidianApiUrl.Other.SHORTURL_API_URL, o.toString());
    return GsonParser.parse(responseContent).get("short_url").getAsString();
  }

  @Override
  public String buildQrConnectUrl(String redirectUri, String scope, String state) {
    return String.format(WxQidianApiUrl.Other.QRCONNECT_URL.getUrl(this.getWxMpConfigStorage()), this.getWxMpConfigStorage().getAppId(),
  ...
  public WxNetCheckResult netCheck(String action, String operator) throws WxErrorException {
    ...
    String responseContent = this.post(WxQidianApiUrl.Other.NETCHECK_URL, o.toString());
  ...
  public void clearQuota(String appid) throws WxErrorException {
    ...
    this.post(WxQidianApiUrl.Other.CLEAR_QUOTA_URL, o.toString());
  }
