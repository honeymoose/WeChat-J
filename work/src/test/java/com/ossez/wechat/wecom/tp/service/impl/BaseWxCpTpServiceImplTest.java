...
import com.ossez.wechat.wecom.bean.WxCpTpAuthInfo;
import com.ossez.wechat.wecom.bean.WxCpTpCorp;
import com.ossez.wechat.wecom.bean.WxCpTpPermanentCodeInfo;
import com.ossez.wechat.wecom.bean.WxTpCustomizedAuthUrl;
...
import com.ossez.wechat.wecom.config.impl.WxCpTpRedissonConfigImpl;
...
public class BaseWxCpTpServiceImplTest {
  ...
  public void testGetPermanentCode() throws WxErrorException {
    ...
    Mockito.doReturn(returnJson).when(tpService).post(configStorage.getApiUrl(WxCpApiPathConsts.Tp.GET_PERMANENT_CODE),
      jsonObject.toString());
  ...
  public void testGetAuthInfo() throws WxErrorException {
    ...
    Mockito.doReturn(returnJson).when(tpService).post(configStorage.getApiUrl(WxCpApiPathConsts.Tp.GET_AUTH_INFO), jsonObject.toString());
