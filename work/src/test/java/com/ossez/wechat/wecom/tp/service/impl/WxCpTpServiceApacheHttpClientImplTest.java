...
import com.ossez.wechat.wecom.bean.WxCpTpCorpId2OpenCorpId;
...
public class WxCpTpServiceApacheHttpClientImplTest {
  ...
  public void testGetSuiteAccessTokenEntity() throws WxErrorException {
    ...
    WeChatAccessToken suiteAccessTokenEntity = wxCpTpService.getSuiteAccessTokenEntity(true);
  ...
  public void testGetCorpToken() throws WxErrorException {
    ...
    WeChatAccessToken accessToken = wxCpTpService.getCorpToken(AUTH_CORP_ID, PERMANENT_CODE, true);
