...
public class WxCpMessageTest {
  ...
  public void TestTemplateCardBuilder_text_notice() {
    ...
    WxCpMessage reply = WxCpMessage.TEMPLATECARD().toUser("OPENID")
      ...
      .toTag("TagID1 | TagID2")
      .agentId(1000002)
      .cardType(WeChatConstant.TemplateCardType.TEXT_NOTICE)
      .taskId("task_id")
...
//    System.out.println(reply.toJson());
  ...
  public void TestTemplateCardBuilder_news_notice() {
    ...
    WxCpMessage reply = WxCpMessage.TEMPLATECARD().toUser("OPENID")
      .agentId(1000002)
      .cardType(WeChatConstant.TemplateCardType.NEWS_NOTICE)
      .sourceIconUrl("图片的url")
      .sourceDesc("企业微信")
      .mainTitleTitle("欢迎使用企业微信")
      .mainTitleDesc("您的好友正在邀请您加入企业微信")
  ...
  public void TestTemplateCardBuilder_button_interaction() {
    ...
    WxCpMessage reply = WxCpMessage.TEMPLATECARD().toUser("OPENID")
      .agentId(1000002)
      .cardType(WeChatConstant.TemplateCardType.BUTTON_INTERACTION)
      .sourceIconUrl("图片的url")
      .sourceDesc("企业微信")
      .mainTitleTitle("欢迎使用企业微信")
      .mainTitleDesc("您的好友正在邀请您加入企业微信")
  ...
  public void TestTemplateCardBuilder_vote_interaction() {
    ...
    WxCpMessage reply = WxCpMessage.TEMPLATECARD().toUser("OPENID")
      .agentId(1000002)
      .cardType(WeChatConstant.TemplateCardType.VOTE_INTERACTION)
      .sourceIconUrl("图片的url")
      .sourceDesc("企业微信")
      .mainTitleTitle("欢迎使用企业微信")
      .mainTitleDesc("您的好友正在邀请您加入企业微信")
  ...
  public void TestTemplateCardBuilder_multiple_interaction() {
    ...
    WxCpMessage reply = WxCpMessage.TEMPLATECARD().toUser("OPENID")
      .agentId(1000002)
      .cardType(WeChatConstant.TemplateCardType.MULTIPLE_INTERACTION)
      .sourceIconUrl("图片的url")
      .sourceDesc("企业微信")
      .mainTitleTitle("欢迎使用企业微信")
      .mainTitleDesc("您的好友正在邀请您加入企业微信")
