...
import com.ossez.wechat.wecom.bean.license.*;
...
public class WxCpTpLicenseServiceImplTest {
  ...
  public void testCrateNewOrder() throws WxErrorException {
    ...
    String result = "{\n" +
      ...
      "}";
    String url =
      configStorage.getApiUrl(WxCpApiPathConsts.License.CREATE_NEW_ORDER) + "?provider_access_token=" + wxCpTpService.getWxCpProviderToken();
  ...
  public void testCreateRenewOrderJob() throws WxErrorException {
    ...
    String result = "{\n" +
      ...
      "}";
    String url =
      configStorage.getApiUrl(WxCpApiPathConsts.License.CREATE_RENEW_ORDER_JOB) + "?provider_access_token=" + wxCpTpService.getWxCpProviderToken();
    when(wxCpTpService.post(eq(url), any(String.class))).thenReturn(result);
  ...
  public void testSubmitRenewOrderJob() throws WxErrorException {
    ...
    String result = "{\n" +
      ...
      "}";
    String url =
      configStorage.getApiUrl(WxCpApiPathConsts.License.SUBMIT_ORDER_JOB) + "?provider_access_token=" + wxCpTpService.getWxCpProviderToken();
    when(wxCpTpService.post(eq(url), any(String.class))).thenReturn(result);
  ...
  public void testGetOrderList() throws WxErrorException {
    ...
    String url = configStorage.getApiUrl(WxCpApiPathConsts.License.LIST_ORDER) + "?provider_access_token=" + wxCpTpService.getWxCpProviderToken();
    when(wxCpTpService.post(eq(url), any(String.class))).thenReturn(result);
    ...
    Assert.assertEquals(orderList.getOrderList().get(0).getOrderId(), orderId);
  ...
  public void testGetOrder() throws WxErrorException {
    ...
    String result = "{\n" +
      ...
      "\t}\n" +
      "}";
    String url = configStorage.getApiUrl(WxCpApiPathConsts.License.GET_ORDER) + "?provider_access_token=" + wxCpTpService.getWxCpProviderToken();
    when(wxCpTpService.post(eq(url), any(String.class))).thenReturn(result);
    ...
    Assert.assertEquals(orderInfo.getOrder().getOrderId(), orderId);

    Assert.assertEquals(orderInfo.getOrder().getCorpId(), corpId);
  ...
  public void testGetOrderAccount() throws WxErrorException {
    ...
    String url =
      configStorage.getApiUrl(WxCpApiPathConsts.License.LIST_ORDER_ACCOUNT) + "?provider_access_token=" + wxCpTpService.getWxCpProviderToken();
    when(wxCpTpService.post(eq(url), any(String.class))).thenReturn(result);
    ...
    Assert.assertEquals(orderAccountList.getAccountList().get(0).getActiveCode(), activeCode);
  ...
  public void testActiveAccount() throws WxErrorException {
    ...
    String url =
      configStorage.getApiUrl(WxCpApiPathConsts.License.ACTIVE_ACCOUNT) + "?provider_access_token=" + wxCpTpService.getWxCpProviderToken();
    when(wxCpTpService.post(eq(url), any(String.class))).thenReturn(result);
  ...
  public void testBatchActiveAccount() throws WxErrorException {
    String result = "{\n" +
      ...
      "}";
    String url =
      configStorage.getApiUrl(WxCpApiPathConsts.License.BATCH_ACTIVE_ACCOUNT) + "?provider_access_token=" + wxCpTpService.getWxCpProviderToken();
    when(wxCpTpService.post(eq(url), any(String.class))).thenReturn(result);
    ...
    Assert.assertEquals(wxCpTpLicenseBatchActiveResultResp.getActiveResults().get(0).getActiveCode(), "aASFINAJOFASF");
  }
  ...
  public void testGetActiveInfoByCode() throws WxErrorException {
    ...
    String url =
      configStorage.getApiUrl(WxCpApiPathConsts.License.GET_ACTIVE_INFO_BY_CODE) + "?provider_access_token=" + wxCpTpService.getWxCpProviderToken();
    when(wxCpTpService.post(eq(url), any(String.class))).thenReturn(result);
    ...
    Assert.assertEquals(activeInfoByCode.getActiveCodeInfo().getActiveCode(), activeCode);
  ...
  public void testGetActiveInfoByUser() throws WxErrorException {
    ...
    String url =
      configStorage.getApiUrl(WxCpApiPathConsts.License.GET_ACTIVE_INFO_BY_USER) + "?provider_access_token=" + wxCpTpService.getWxCpProviderToken();
    when(wxCpTpService.post(eq(url), any(String.class))).thenReturn(result);
    ...
    Assert.assertEquals(activeInfoByUser.getActiveInfoList().get(0).getActiveCode(), activeCode);
  }
  ...
  public void testBatchGetActiveInfoByUser() throws WxErrorException {
    ...
    String url =
      configStorage.getApiUrl(WxCpApiPathConsts.License.BATCH_GET_ACTIVE_INFO_BY_CODE) + "?provider_access_token=" + wxCpTpService.getWxCpProviderToken();
    when(wxCpTpService.post(eq(url), any(String.class))).thenReturn(result);
  ...
  public void testGetCorpAccountList() throws WxErrorException {
    ...
    String url =
      configStorage.getApiUrl(WxCpApiPathConsts.License.LIST_ACTIVED_ACCOUNT) + "?provider_access_token=" + wxCpTpService.getWxCpProviderToken();
    when(wxCpTpService.post(eq(url), any(String.class))).thenReturn(result);
    ...
    Assert.assertEquals(accountList.getOrderList().get(0).getUserid(), userid);
  }
  ...
  public void testBatchTransferLicense() throws WxErrorException {
    ...
    String url =
      configStorage.getApiUrl(WxCpApiPathConsts.License.BATCH_TRANSFER_LICENSE) + "?provider_access_token=" + wxCpTpService.getWxCpProviderToken();
    when(wxCpTpService.post(eq(url), any(String.class))).thenReturn(result);
