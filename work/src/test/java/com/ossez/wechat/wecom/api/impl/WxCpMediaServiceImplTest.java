...
import com.ossez.wechat.wecom.api.TestConstants;
...
public class WxCpMediaServiceImplTest {
  ...
  public Object[][] mediaData() {
    return new Object[][]{
      ...
      new Object[]{WeChatConstant.MediaFileType.VOICE, TestConstants.FILE_AMR, "mm.amr"},
      new Object[]{WeChatConstant.MediaFileType.VIDEO, TestConstants.FILE_MP4, "mm.mp4"},
      new Object[]{WeChatConstant.MediaFileType.FILE, TestConstants.FILE_JPG, "mm.jpeg"}
    };
  }
