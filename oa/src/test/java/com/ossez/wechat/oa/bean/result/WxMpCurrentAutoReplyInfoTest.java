...
public class WxMpCurrentAutoReplyInfoTest {
  ...
  public void testFromJson() throws Exception {
    ...
    Assert.assertTrue(autoReplyInfo.getIsAddFriendReplyOpen());
    Assert.assertTrue(autoReplyInfo.getIsAutoReplyOpen());
    Assert.assertNotNull(autoReplyInfo.getAddFriendAutoReplyInfo());
    Assert.assertNotNull(autoReplyInfo.getMessageDefaultAutoReplyInfo());
    Assert.assertTrue(autoReplyInfo.getKeywordAutoReplyInfo().getList().size() > 0);
