...
public class WxMpAdLeadResultTest {
  ...
  public void testFromJson() throws Exception {
    ...
    Assert.assertNotNull(adLeadResult);
    Assert.assertNotNull(adLeadResult.getPageInfo());
    Assert.assertNotNull(adLeadResult.getAdLeads());
    Assert.assertTrue(adLeadResult.getAdLeads().size() > 0);
