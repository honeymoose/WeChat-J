...
import com.ossez.wechat.open.bean.ma.WxMaOpenCommitExtInfo;
import com.ossez.wechat.open.bean.ma.WxMaOpenCommitStandardExt;
import com.ossez.wechat.open.bean.ma.WxMaPrefetchDomain;
...
public interface WxOpenMaService extends WxMaService {
   ...
   * @return the wx open result
   * @throws WxErrorException the wx error exception
   * @see WxMaOpenCommitStandardExt
   * @see WxMaOpenCommitExtInfo
   */
